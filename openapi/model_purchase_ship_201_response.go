...
type _PurchaseShip201Response PurchaseShip201Response
...
func (o *PurchaseShip201Response) UnmarshalJSON(data []byte) (err error) {
	...
	varPurchaseShip201Response := _PurchaseShip201Response{}

	err = json.Unmarshal(data, &varPurchaseShip201Response)

	if err != nil {
		return err
	}

	*o = PurchaseShip201Response(varPurchaseShip201Response)
