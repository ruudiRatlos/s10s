...
// checks if the PurchaseShip201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PurchaseShip201ResponseData{}
...
type _PurchaseShip201ResponseData PurchaseShip201ResponseData
...
func NewPurchaseShip201ResponseData(agent Agent, ship Ship, transaction ShipyardTransaction) *PurchaseShip201ResponseData {
	this := PurchaseShip201ResponseData{}
	this.Agent = agent
	this.Ship = ship
...
func (o *PurchaseShip201ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varPurchaseShip201ResponseData := _PurchaseShip201ResponseData{}

	err = json.Unmarshal(data, &varPurchaseShip201ResponseData)

	if err != nil {
		return err
	}

	*o = PurchaseShip201ResponseData(varPurchaseShip201ResponseData)
...
type NullablePurchaseShip201ResponseData struct {
	value *PurchaseShip201ResponseData
	isSet bool
}

func (v NullablePurchaseShip201ResponseData) Get() *PurchaseShip201ResponseData {
	return v.value
}

func (v *NullablePurchaseShip201ResponseData) Set(val *PurchaseShip201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePurchaseShip201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePurchaseShip201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePurchaseShip201ResponseData(val *PurchaseShip201ResponseData) *NullablePurchaseShip201ResponseData {
	return &NullablePurchaseShip201ResponseData{value: val, isSet: true}
}
