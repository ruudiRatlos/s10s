...
// checks if the ShipRefine201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShipRefine201Response{}
...
type _ShipRefine201Response ShipRefine201Response
...
func (o *ShipRefine201Response) GetData() ShipRefine201ResponseData {
	if o == nil {
		var ret ShipRefine201ResponseData
		return ret
	}
...
func (o *ShipRefine201Response) UnmarshalJSON(data []byte) (err error) {
	...
	varShipRefine201Response := _ShipRefine201Response{}

	err = json.Unmarshal(data, &varShipRefine201Response)

	if err != nil {
		return err
	}

	*o = ShipRefine201Response(varShipRefine201Response)
...
type NullableShipRefine201Response struct {
	value *ShipRefine201Response
	isSet bool
}

func (v NullableShipRefine201Response) Get() *ShipRefine201Response {
	return v.value
}

func (v *NullableShipRefine201Response) Set(val *ShipRefine201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableShipRefine201Response) IsSet() bool {
	return v.isSet
}
...
func NewNullableShipRefine201Response(val *ShipRefine201Response) *NullableShipRefine201Response {
	return &NullableShipRefine201Response{value: val, isSet: true}
}
