...
// checks if the DeliverContractRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeliverContractRequest{}
...
type _DeliverContractRequest DeliverContractRequest
...
func (o *DeliverContractRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = DeliverContractRequest(varDeliverContractRequest)
...
func (v NullableDeliverContractRequest) Get() *DeliverContractRequest {
	return v.value
}

func (v *NullableDeliverContractRequest) Set(val *DeliverContractRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeliverContractRequest) IsSet() bool {
	return v.isSet
}
...
func NewNullableDeliverContractRequest(val *DeliverContractRequest) *NullableDeliverContractRequest {
	return &NullableDeliverContractRequest{value: val, isSet: true}
}
