...
func (o *SupplyConstruction201Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSupplyConstruction201Response := _SupplyConstruction201Response{}

	err = json.Unmarshal(data, &varSupplyConstruction201Response)

	if err != nil {
		return err
	}

	*o = SupplyConstruction201Response(varSupplyConstruction201Response)
