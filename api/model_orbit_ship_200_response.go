...
// checks if the OrbitShip200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrbitShip200Response{}
...
type _OrbitShip200Response OrbitShip200Response
...
func (o *OrbitShip200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varOrbitShip200Response := _OrbitShip200Response{}

	err = json.Unmarshal(data, &varOrbitShip200Response)

	if err != nil {
		return err
	}

	*o = OrbitShip200Response(varOrbitShip200Response)
...
type NullableOrbitShip200Response struct {
	value *OrbitShip200Response
	isSet bool
}

func (v NullableOrbitShip200Response) Get() *OrbitShip200Response {
	return v.value
}

func (v *NullableOrbitShip200Response) Set(val *OrbitShip200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOrbitShip200Response) IsSet() bool {
	return v.isSet
}
...
func NewNullableOrbitShip200Response(val *OrbitShip200Response) *NullableOrbitShip200Response {
	return &NullableOrbitShip200Response{value: val, isSet: true}
}
