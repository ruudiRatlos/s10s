...
// checks if the SurveyDeposit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SurveyDeposit{}
...
type _SurveyDeposit SurveyDeposit
...
func (o *SurveyDeposit) UnmarshalJSON(data []byte) (err error) {
	...
	varSurveyDeposit := _SurveyDeposit{}

	err = json.Unmarshal(data, &varSurveyDeposit)

	if err != nil {
		return err
	}

	*o = SurveyDeposit(varSurveyDeposit)
...
func (v NullableSurveyDeposit) Get() *SurveyDeposit {
	return v.value
}
...
func NewNullableSurveyDeposit(val *SurveyDeposit) *NullableSurveyDeposit {
	return &NullableSurveyDeposit{value: val, isSet: true}
}
