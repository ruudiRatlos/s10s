...
type _ScannedShipReactor ScannedShipReactor
...
func (o *ScannedShipReactor) UnmarshalJSON(data []byte) (err error) {
	...
	varScannedShipReactor := _ScannedShipReactor{}

	err = json.Unmarshal(data, &varScannedShipReactor)

	if err != nil {
		return err
	}

	*o = ScannedShipReactor(varScannedShipReactor)
