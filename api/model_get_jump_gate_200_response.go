...
// checks if the GetJumpGate200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetJumpGate200Response{}
...
type _GetJumpGate200Response GetJumpGate200Response
...
func (o *GetJumpGate200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetJumpGate200Response := _GetJumpGate200Response{}

	err = json.Unmarshal(data, &varGetJumpGate200Response)

	if err != nil {
		return err
	}

	*o = GetJumpGate200Response(varGetJumpGate200Response)
...
type NullableGetJumpGate200Response struct {
	value *GetJumpGate200Response
	isSet bool
}

func (v NullableGetJumpGate200Response) Get() *GetJumpGate200Response {
	return v.value
}

func (v *NullableGetJumpGate200Response) Set(val *GetJumpGate200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetJumpGate200Response) IsSet() bool {
	return v.isSet
}
...
func NewNullableGetJumpGate200Response(val *GetJumpGate200Response) *NullableGetJumpGate200Response {
	return &NullableGetJumpGate200Response{value: val, isSet: true}
}
