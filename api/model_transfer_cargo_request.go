...
type _TransferCargoRequest TransferCargoRequest
...
func (o *TransferCargoRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTransferCargoRequest := _TransferCargoRequest{}

	err = json.Unmarshal(data, &varTransferCargoRequest)

	if err != nil {
		return err
	}

	*o = TransferCargoRequest(varTransferCargoRequest)
